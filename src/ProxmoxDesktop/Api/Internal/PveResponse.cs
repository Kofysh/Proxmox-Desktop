...
internal sealed class PveResponse<T>     { [JsonPropertyName("data")] public T?      Data { get; init; } }
internal sealed class PveListResponse<T> { [JsonPropertyName("data")] public List<T>? Data { get; init; } }
